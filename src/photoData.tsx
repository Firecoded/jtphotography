...
export const photos: IPhoto[] = [
    ...
    },
    {
        ...
        width: 2048,
        height: 1367,
        alt: "Street scene in Da Nang, Vietnam at dusk with neon restaurant signs, a blue bus, motorbikes, and pedestrians under a sunset sky.",
        keywords: [EPhotoKeywords.All, EPhotoKeywords.Architecture, EPhotoKeywords.Street],
        location: [ELocation.All, ELocation.Vietnam],
        thumbnail: "/images/thumbnails/67_600px.webp",
        rating: 8,
    },
    {
        id: 68,
        ...
        width: 2048,
        height: 1367,
        alt: "Night market scene in Vietnam with colorful souvenirs, plush toys, and tote bags for sale. A vendor and a shopper engage under bright hanging lights.",
        keywords: [EPhotoKeywords.All, EPhotoKeywords.Street, EPhotoKeywords.Documentary],
        location: [ELocation.All, ELocation.Vietnam],
        thumbnail: "/images/thumbnails/68_600px.webp",
        rating: 7,
    },
    {
        id: 69,
        ...
        width: 2048,
        height: 1365,
        alt: "Colorful lanterns, palm trees, and a shirtless man with a surfboard on a tropical beach walkway in Da Nang, Vietnam at dusk.",
        keywords: [EPhotoKeywords.All, EPhotoKeywords.Street, EPhotoKeywords.Portrait],
        location: [ELocation.All, ELocation.Vietnam],
        thumbnail: "/images/thumbnails/69_600px.webp",
        rating: 7,
    },
